// crossdle-answers.js
// The curated list of possible SECRET words (and decoy words) for
// CROSSDLE, grouped by
...
//
// This is separate from the guess-validation dictionary (see
// dictionary.js), which is enormous (300,000+ words) and used only to
// check whether a viewer's guess is a real, recognizable word. Drawing
// the SECRET ANSWER (and the decoy word) from this small curated list
// instead of the full dictionary means the word chat is trying to solve
// is always a common, recognizable word — never an obscure dictionary
// entry nobody would guess. Adapted from BLINDLE's own answers list, so
// both games draw secret words from the same familiar word bank.
